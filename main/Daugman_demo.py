...
with st.spinner('Loading Image...'):
    ...
    img_1_L = read_image(
        f'Iris-Dataset/CASIA-Iris-Thousand/{str(img_1_fol).zfill(3)}/L/S5{str(img_1_fol).zfill(3)}L{str(img_1_item).zfill(2)}.jpg')

    img_1_R = read_image(
        f'Iris-Dataset/CASIA-Iris-Thousand/{str(img_1_fol).zfill(3)}/R/S5{str(img_1_fol).zfill(3)}R{str(img_1_item).zfill(2)}.jpg')

    img_2_L = read_image(
        f'Iris-Dataset/CASIA-Iris-Thousand/{str(img_2_fol).zfill(3)}/L/S5{str(img_2_fol).zfill(3)}L{str(img_2_item).zfill(2)}.jpg')

    img_2_R = read_image(
        f'Iris-Dataset/CASIA-Iris-Thousand/{str(img_2_fol).zfill(3)}/R/S5{str(img_2_fol).zfill(3)}R{str(img_2_item).zfill(2)}.jpg')
